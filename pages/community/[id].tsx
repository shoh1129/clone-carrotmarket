...
const CommunityPostDetail: NextPage = () => {
  ...
  const { data, mutate } = useSWRHandler<CommunityPostResponse>(
  ...
  const onValid = (answerData: AnswerForm) => {
    ...
    <Layout canGoBack>
      <div>
        ...
        <div className="px-4 my-5 space-y-5">
          {
            data?.post?.answers?.map((answer: AnswerWithUser, index: number) => (
